-- Original author Boesner, 
-- credit @Murten101 globals, @jjrbt improved "sethash" function @randomAlt69420 tabels
-- pg.40
...
menu.add_action("________________", function() end)
local delay = 0.01
local currentHash = 0;
menu.add_float_range("Delay Time", 0.01, 0.01, 0.5, function() end, function(value) delay = value end)
...
{"a_c_stingray ", 0xA148614D}
	...
	menu.add_action("Normal Skin", function()
...
local plPed = player.get_player_ped(localplayer:get_player_id())
...
menu.add_int_range("Female Skins:", 1, 1, #PedModelFemale, function() end, function(value)
	sethash(PedModelFemale[value][2]) 
	--sleep(delay)
end)
 
menu.add_action("Random Female", function()
					    	
		local rdm = math.floor(math.random(1, #PedModelFemale))
		
				sethash(PedModelFemale[rdm][2])
 
    end)
 
menu.add_int_range("Male Skins:", 1, 1, #PedModel1, function() end, function(value)
	sethash(PedModel1[value][2]) 
 
		--sleep(delay)
end)
menu.add_action("Random Male", function()
			
				    	
		local rdm = math.floor(math.random(1, #PedModel1))
		
				sethash(PedModel1[rdm][2])
	
		
    end)
 
menu.add_int_range("Animal Skins:", 1, 1, #PedModelAnimal, function() end, function(value)
 
	sethash(PedModelAnimal[value][2]) 
		--sleep(delay)
end)
menu.add_action("Random Animal", function()
			
				    	
		local rdm = math.floor(math.random(1, #PedModelAnimal))
		
				sethash(PedModelAnimal[rdm][2])
...
menu.add_int_range("Sea Animal Skins:", 1, 1, #PedModelSea, function() end, function(value)
	sethash(PedModelSea[value][2]) 
		--sleep(delay)
end)
menu.add_action("Random Sea Animal", function()
			
				    	
		local rdm = math.floor(math.random(1, #PedModelSea))
		
				sethash(PedModelSea[rdm][2])
